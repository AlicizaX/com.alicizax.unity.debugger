...
namespace AlicizaX.Debugger
{
    public sealed partial class DebuggerComponent
    {
        private static class DebuggerTheme
        {
            ...
            public static readonly Color SidebarRowHover = new Color32(255, 255, 255, 10);
            public static readonly Color SidebarRowPressed = new Color32(255, 255, 255, 16);
            ...
            public static readonly Color SidebarGroupText = new Color32(150, 160, 180, 255);
            public static readonly Color SidebarTreeGuide = new Color32(255, 255, 255, 18);
            public static readonly Color ScrollbarTrack = new Color32(255, 255, 255, 12);
            public static readonly Color ScrollbarThumb = new Color32(255, 255, 255, 38);
            public static readonly Color ScrollbarThumbHover = new Color32(255, 255, 255, 72);
            public static readonly Color ScrollbarThumbPressed = new Color32(130, 170, 230, 180);
            public static readonly Color Caret = new Color32(255, 255, 255, 255);
            public static readonly Color CaretGlow = new Color32(160, 210, 255, 90);
            public static readonly Color TextSelection = new Color32(82, 130, 210, 140);
